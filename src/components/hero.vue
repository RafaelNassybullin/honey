<template>
  <div class="wrapper-hero">
    <div class="honey-liquid">
      <img src="../assets/media/honeyliquid.png" alt="">
    </div>
    <div class="hero">
      <h2 class="finger">Finger</h2>
      <h2 class="licking">licking</h2>
      <h2 class="honey-word">honey!</h2>
      <div class="bee">
        <img src="../assets/media/bee.png" alt="">
      </div>
      <div class="line"></div>
      <div class="buttons">
...
.hero {
  ...
  height: 60.069vw;
  overflow: hidden;
  background-image: linear-gradient(35deg, #FF9D2D, #FFD877);
...
transform: translateY(54vw);
  ...
  h2 {
    font-family: 'Kochasan Bold', sans-serif;
    font-size: 6.944vw;
    position: absolute;
    z-index: 2;
    @media(max-width: 433px){
